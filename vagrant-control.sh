...
#
#refresh_machine() {
#    refresh_command ${id$machineId}
#    read_data
#}
#
#start_machine() {
#    start_command ${id$machineId}
#    read_data
#}
#
#halt_machine() {
#    halt_command ${id$machineId}
#    read_data
#}
#
#ssh_machine() {
#    get_machine_state ${id$machineId}
#    if [[ $machineState == $STATE_RUNNING ]]; then
#        ssh_command ${id$machineId}
